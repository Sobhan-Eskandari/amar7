    ...
    <div class="container">
        ...
        <div class="row" id="abouUsSection">
            ...
            <div class="col-12">
                <img src="images/Horoofnegar-blak.png">
                <h3>درباره ما</h3>
                <p id="toShowText">{{ isset($info['aboutUs_txt']) ? $info['aboutUs_txt'] : "پیش فرض" }}</p>
            </div>
            ...
            <button type="button" class="btn btn-primary"><a style="color: whitesmoke" href="{{ route('contact-us') }}">تماس با ما</a></button>
        </div>
    </div>
