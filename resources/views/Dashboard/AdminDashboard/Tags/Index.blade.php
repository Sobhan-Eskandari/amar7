    ...
    <div class="container">
        <div class="row searh_box">
            <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                {!! Form::open(['method'=>'GET','action'=>'Tagscontroller@search']) !!}
        ...
        <div class="col-lg-6 col-md-6 col-xs-8 pdding_left">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="edit"><a href="{{route('tags.edit',$tag->id)}}"><button style="border: none; background: none; color: black">ویرایش</button></a></td>
                    <td class="delet">
