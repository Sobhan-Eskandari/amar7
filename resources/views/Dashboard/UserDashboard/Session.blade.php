                ...
                <div class="container">
                    ...
                    @foreach($sessions as $session)
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-12 pull-lg-8 offset-lg-1">
                            <a href="../zipFiles/{{ $session->session_file }}"><button class="downloadCourse"> دانلود زیر محتوا<i class="fa fa-download" aria-hidden="true"></i> </button></a>
                        </div>
                    </div>
                    @endforeach
                </div>
